...
API_ID = int(os.environ.get("API_ID", 20977199)
API_HASH = os.environ.get("API_HASH", "de8cf36cc1d274a70206b990259a830e")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8244226484:AAGQ_LagDLOyENECCtlwgSHLFKearTawP3A")
